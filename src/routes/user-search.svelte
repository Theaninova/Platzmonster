<script lang="ts">
  ...
  import EditUserAction from "../lib/components/types/actions/EditUserAction.svelte"
</script>

<h1>User Search</h1>

<SearchPage action="/api/search/user" listItem={UserListItem} actionButtons={EditUserAction} />
