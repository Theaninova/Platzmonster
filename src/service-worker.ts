...
const routes = ["/", "/login", "/register", "/about", "/user-search"]

// hard-coded list of other assets necessary for page load outside our domain
const customAssets = [
  "https://fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200",
  "https://fonts.googleapis.com/css2?family=Kanit:ital,wght@0,400;0,500;0,700;0,800;1,400;1,500;1,700&display=swap",
]
...
async function fetchAndCache(request: Request) {
  ...
  try {
    ...
    if (response) {
      return response
    } else if (request.url.endsWith("__data.json")) {
      return new Response(JSON.stringify({}))
    } else if (request.url.endsWith("version.json")) {
